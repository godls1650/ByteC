...
INT_PTR CALLBACK    TestDlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam) {
    static bool hobby[3];
    static bool gender;
    static TCHAR szGender[2][10] = { _T("남"),_T("여") };
    static TCHAR szHobby[3][20] = { _T("영화감상"), _T("독서"), _T("게임") };
    TCHAR tmpName[50];
    TCHAR tmpAddr[50];
    FILE* fp;
    switch (message) {
    case WM_INITDIALOG:
        ...
        SetDlgItemText(hDlg, IDC_EDIT_NAME, _T("이름"));
        SetDlgItemText(hDlg, IDC_EDIT_ADDR, _T("주소"));
