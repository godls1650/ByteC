...
BEGIN_MESSAGE_MAP(CMFCPainterView, CView)
	...
	//ON_COMMAND(IDM_COLOR_EDIT, &CMFCPainterView::OnColorEdit)
//	ON_COMMAND(IDC_BUTTON1, &CMFCPainterView::OnButton1)
END_MESSAGE_MAP()
...
void CMFCPainterView::OnDraw(CDC* pDC)
{
	...
	CPen pen, * oldPen;
	pen.CreatePen(PS_SOLID, 10, pDoc->color);
	oldPen = pDC->SelectObject(&pen);
	Rectangle(*pDC, 100, 100, 200, 200);
...
BOOL CMFCPainterView::OnPreparePrinting(CPrintInfo* pInfo)
{
	// 기본적인 준비
	return DoPreparePrinting(pInfo);
}

void CMFCPainterView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// TODO: 인쇄하기 전에 추가 초기화 작업을 추가합니다.
}

void CMFCPainterView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
...
//void CMFCPainterView::OnColorEdit()
//{
//	// TODO: 여기에 명령 처리기 코드를 추가합니다.
//	// 공용 대화상자 클래스 -> 
//	/*
//	OPENFILENAME / SAVEFILENAME ==> CFileDialog 
//	*/
...
//void CMFCPainterView::OnButton1()
//{
//	// TODO: 여기에 명령 처리기 코드를 추가합니다.
//	CTestDlg test;
//	
